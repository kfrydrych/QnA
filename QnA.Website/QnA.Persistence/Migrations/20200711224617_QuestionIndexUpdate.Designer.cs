...
namespace QnA.Persistence.Migrations
{
    ...
    [Migration("20200711224617_QuestionIndexUpdate")]
    partial class QuestionIndexUpdate
    {
            ...
            modelBuilder.Entity("QnA.Domain.Models.Session", b =>
                {
                    ...
                    b.HasIndex("AccessCode", "Status")
                        .HasAnnotation("SqlServer:Include", new[] { "Title" });

                    b.HasIndex("CreatedBy", "Created")
                        .HasAnnotation("SqlServer:Include", new[] { "Title", "Status" });
            ...
            modelBuilder.Entity("QnA.Domain.Models.Vote", b =>
                {
                    ...
                    b.HasIndex("QuestionId", "CreatedBy");
