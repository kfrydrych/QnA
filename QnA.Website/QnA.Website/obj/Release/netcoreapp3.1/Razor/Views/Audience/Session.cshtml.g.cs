#pragma checksum "C:\Users\Crash\Desktop\QnA\QnA.Website\QnA.Website\Views\Audience\Session.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "250d3e1af93d20d83664977a3ea1577d1082d1ee"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"250d3e1af93d20d83664977a3ea1577d1082d1ee", @"/Views/Audience/Session.cshtml")]
...
<script type=""text/template"" data-template=""question"">
    <div id=""${id}"" class=""list-group-item"" data-score=""${score}"">
        <div class=""row"">
            <div class=""col-xs-1"">
                <i class=""far fa-arrow-alt-circle-up fa-2x mb-3 js-btn-vote"" data-questionId=""${id}"" data-canvote=""${canVote}""></i>
...
");
    ...
    ");
                WriteLiteral(@"    connection.start().catch(function (err) {
        ...
        function updateVoteButtons() {
            $('.js-btn-vote').each(function (index) {
                const canVote = $(this).attr('data-canvote');
                if (canVote == 'true') {
    ...
    ");
                WriteLiteral(@"        const url = window.location.href;
        ...
        const TemplateBuilder = function () {
            ...
            function build(data, templateName, targetSelector) {
                ...
                if (template == """" || template == null || template == 'undefined')
                    ");
                WriteLiteral(@"console.log('Error: cound not find the script template with attribute data-template: ""' +
                        templateName +
                        '"" on page');
